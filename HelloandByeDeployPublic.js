...
const content = fs.readFileSync('HelloandBye.sol').toString() // en content, en una tira de caracteres hemos guardado el contrato
...
const bytecodeContract = output.contracts.holaychao.HelloandBye.evm.bytecode.object   
